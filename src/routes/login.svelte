...
<svelte:head>
	<title>Login to destinations</title>
</svelte:head>
...
{#if state !== 'success'}
	<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
		<div class="w-full max-w-md space-y-8">
			...
			<form class="mt-8 space-y-6" action="#" method="POST" on:submit|preventDefault={handleSubmit}>
				...
				<div>
					...
					{#if state instanceof Error}
						<p class="my-4 text-sm">
							Whoops, there was an error sending a mail to {email} .. maybe try again..
						</p>
					{/if}
				</div>
			</form>
