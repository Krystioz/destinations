...
{#if state == 'validating'}
	<p class="text-center">Validating the link</p>
		...
		<div class="w-full max-w-md space-y-8">
			<div>
				...
				<h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
					Confirm access to Destinations
				</h2>
				<p class="mt-5 text-center text-xs">
					You may have been arleady but maybe you may have logged in from different device
				</p>
